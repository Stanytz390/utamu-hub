...
function AdminDashboard() {
  ...
  // Sign out from Supabase and clear admin session
  const signOut = async () => {
  ...
  if (!authenticated) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg border w-96">
          ...
          <p className="text-xs text-gray-400 mt-4 text-center">Enter the admin password to access the panel.</p>
        </div>
      </div>
    );
  }
  ...
  const tabs = [
    ...
    { id: "redeem", label: "Redeem Links", icon: "fa-gift" },
...
// ============================================
// All Content Components (identical to previous)
// ============================================
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th className="px-4 py-3 text-left">Name</th><th className="px-4 py-3 text-left">Email</th><th className="px-4 py-3 text-left">Role</th><th className="px-4 py-3 text-left">Phone</th><th className="px-4 py-3 text-left">Actions</th></tr>
          </thead>
          <tbody>
            {users.map(u => (
              <tr key={u.id} className="border-t border-gray-100">
                ...
                <td className="px-4 py-3"><button onClick={() => deleteUser(u.id)} className="text-red-500"><i className="fas fa-trash"></i></button></td>
              </tr>
            ))}
          </tbody>
        </table>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th>Title</th><th>Category</th><th>Price (SQ)</th><th>Status</th><th>Creator</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {videos.map(v => (
              <tr key={v.id} className="border-t border-gray-100">
                ...
                <td className="px-4 py-3"><button onClick={() => toggleStatus(v.id, v.status)} className={`px-2 py-1 rounded text-xs ${v.status === "available" ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"}`}>{v.status}</button></td>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th>Name</th><th>Members</th><th>Price</th><th>Link</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {groups.map(g => (
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th>Name</th><th>Email</th><th>WhatsApp</th><th>Services</th><th>Price</th><th>Approved</th><th>Contact</th><th>Balance</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {businesses.map(b => {
              ...
              return (
                <tr key={b.id} className="border-t border-gray-100">
                  ...
                  <td className="px-4 py-3">{contact?.whatsapp ? <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" className="text-green-600 hover:underline">{contact.whatsapp}</a> : "—"}</td>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th>User</th><th>Status</th><th>Expires</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {stories.map(s => (
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr><th>Code</th><th>Coins</th><th>Used / Max</th><th>Expires</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {links.map(l => (
