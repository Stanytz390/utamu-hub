...
// ============================================================
// 1. SERVER FUNCTIONS (Zote zinatoka hapa)
// ============================================================
      ...
      <div className="flex items-center justify-center min-h-screen bg-[#050505] px-4">
        <div className="max-w-md w-full bg-[#111] rounded-3xl border border-white/5 p-8 shadow-xl">
          <div className="text-center mb-6">
            <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-primary to-secondary shadow-[0_0_30px_rgba(254,44,85,0.5)]">
          ...
          <form onSubmit={handlePasswordSubmit}>
            ...
            <button
              type="submit"
              className="mt-4 w-full rounded-xl bg-gradient-to-r from-primary to-secondary py-4 font-bold text-white shadow-[0_0_30px_rgba(254,44,85,0.3)] hover:opacity-90 transition"
            >
              Unlock
            </button>
          </form>
    ...
    <div className="flex min-h-screen bg-[#050505] text-white font-sans">
      ...
      `}>
        <div className="p-6 border-b border-white/5 hidden md:block">
          <h1 className="text-xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">UTAMU PORI</h1>
          ...
          {menuItems.map((item) => (
            <button
              ...
              className={`flex items-center w-full gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all
                ${activeTab === item.id ? "bg-gradient-to-r from-primary to-secondary text-white shadow-[0_0_20px_rgba(254,44,85,0.3)]" : "text-muted-foreground hover:bg-white/5"}
              `}
            >
...
function VideosContent() {
  ...
  return (
    <div className="space-y-6">
      <button onClick={() => setShowAdd(!showAdd)} className="w-full md:w-auto bg-gradient-to-r from-primary to-secondary py-4 px-8 rounded-2xl font-black flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(254,44,85,0.3)] transition-transform active:scale-95">
...
function GroupsContent() {
  ...
  return (
    <div className="space-y-6">
      <button onClick={() => setShowAdd(!showAdd)} className="w-full md:w-auto bg-gradient-to-r from-secondary to-purple-400 text-black py-4 px-8 rounded-2xl font-black flex items-center justify-center gap-2 active:scale-95 transition-all">
  ...
  return (
    <div className="space-y-6">
      <div className="bg-[#111] p-6 rounded-3xl border border-white/5 space-y-4 max-w-xl">
        ...
        <button onClick={generate} className="w-full bg-gradient-to-r from-primary to-secondary py-4 rounded-2xl font-black shadow-[0_0_30px_rgba(254,44,85,0.3)]">GENERATE CODE</button>
      </div>
